...
public class SocketClient implements Runnable {
    ...
    public SocketClient(ChatFrame frame) {
        ...
        try {
			...
			System.out.println(e+" in SocketClient.java");
		}
            ...
            try {
                ...
                if(msg.type.equals("message")){
                    ...
                    if(msg.recipient.equals(ui.username)) {
                        ui.jTextArea1.append("["+msg.sender +" > Me] : " + Encryption.decrypt(msg.content.getBytes()) + "\n");
                    } else {
                        ui.jTextArea1.append("["+ msg.sender +" > "+ msg.recipient +"] : " + Encryption.decrypt(msg.content.getBytes()) + "\n");
                    }                  
