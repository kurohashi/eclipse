...
public class Encryption {
	...
	private static byte[] key = "p^5*/-+~m!)\"v@#$".getBytes();
	...
	public static String encrypt(byte[] in){
		...
		String base64EncodedString = Base64.getEncoder().encodeToString(tmp);
		tmp = base64EncodedString.getBytes();
	...
	public static String decrypt(byte[] in) {
		...
		byte[] base64DecodedString = Base64.getDecoder().decode(in);
		in = base64DecodedString;
